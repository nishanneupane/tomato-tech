          ...
          {imageSource === 'camera' && !capturedImage && (
            <>
              ...
              <button 
                ...
                className="w-full bg-blue-600 text-white py-4 rounded-lg hover:bg-blue-700 transition duration-300 text-lg font-semibold hover:scale-102 active:scale-98 shadow-md"
              >
                Switch Camera
              </button>
            </>
